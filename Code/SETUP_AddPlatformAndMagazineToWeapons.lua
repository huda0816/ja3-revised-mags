function REV_SetupWeapon(weaponClass, plattform, mag, defaultMod, availableMods)
	...
	local magazineSlot = table.find_value(componentSlots, "SlotType", "Magazine")

	if magazineSlot then
		magazineSlot.DefaultComponent = defaultMod
		magazineSlot.AvailableComponents = availableMods
	end
...
function OnMsg.ClassesPostprocess()
	...
	table.insert(LionRoar.ComponentSlots, PlaceObj('WeaponComponentSlot', {
		'SlotType', "Magazine",
		'Modifiable', false,
		'AvailableComponents', {
			"MagLarge",
	...
	table.insert(GoldenGun.ComponentSlots, PlaceObj('WeaponComponentSlot', {
		'SlotType', "Magazine",
		'Modifiable', false,
		'AvailableComponents', {
			"MagLarge",
...
function OnMsg.ClassesPreprocess()
	...
	REV_SetupWeapon(RPK74, "AK762", "AK47MagazineMagLarge", "MagLarge", { "MagLarge", "MagLarger", "MagNormal" })
