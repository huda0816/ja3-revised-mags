...
-- 								"__condition",
-- 								function(parent, context)
-- 									return context:IsWeapon() and context.ComponentSlots and
-- 										#context.ComponentSlots > 0 and 0 < CountWeaponUpgrades(context)
-- 								end,
-- 								"__class",
-- 								"XImage",
-- 								"RolloverText",
...
-- 							"condition",
-- 							function(parent, context, item, i)
-- 								return item and not not GetBulletCount(item) and item:IsWeapon() and
-- 									not item.parent_weapon and item.ReloadAP
-- 							end,
-- 							"__context",
-- 							function(parent, context, item, i, n)
-- 								return item
...
-- 												local enabled = canReload and
-- 													CombatActions.Reload:GetVisibility(units) == "enabled"
-- 												self:SetEnabled(true)
-- 												self:ResolveId("node").context.item = weapon
-- 												self:ResolveId("node").context.unit = units[1]
-- 											end,
...
-- 										local canReload = wepIdx
-- 										local enabled = canReload and
-- 											CombatActions.Reload:GetVisibility({ unit }) == "enabled"
-- 										self:SetEnabled(true)
...
-- 												CombatActionAttackStart(action, Selection, { free_aim = true },
-- 													"IModeCombatFreeAim")
-- 											end
-- 										end,
-- 										"AltPress",
...
-- 											"array",
-- 											function(parent, context)
-- 												return IsKindOf(context, "FirearmBase") and
-- 													table.values(context.subweapons)
-- 											end,
-- 											"condition",
-- 											function(parent, context, item, i)
-- 												return context
