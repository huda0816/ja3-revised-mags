...
-- 		if args and args.item_id then
-- 			local alt_set = (unit.current_weapon == "Handheld A") and "Handheld B" or "Handheld A"
-- 			weapon = FindWeaponInSlotById(unit, unit.current_weapon, args.item_id) or
-- 			FindWeaponInSlotById(unit, alt_set, args.item_id) or FindWeaponInSlotById(unit, "Inventory", args.item_id)
-- 		end
...
-- 					}
-- 					if isCurrent then table.insert(processedAmmo, 1, ammoEntry) else table.insert(processedAmmo,
-- 							ammoEntry) end
-- 				end
...
-- 				end
-- 				mode_dlg:ShowCombatActionTargetChoice(self, { u }, weaponWrapped.ammo, ammoChoiceCallback,
-- 					"suppress_toggle")
-- 			end
